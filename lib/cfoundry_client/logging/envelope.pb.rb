...
require "beefcake"
require 'cfoundry_client/logging/error.pb'
require 'cfoundry_client/logging/http.pb'
require 'cfoundry_client/logging/log.pb'
require 'cfoundry_client/logging/metric.pb'
